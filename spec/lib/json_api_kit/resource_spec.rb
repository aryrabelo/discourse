...
RSpec.describe JsonApiKit::Resource do
  ...
  describe ".has_many" do
    ...
    context "when the declaration names no resource" do
      ...
      it "relates to the resource its singular name matches" do
        expect(author_relationships.first.resource).to eq(SpecBlog::AuthorResource)
      end
    end
  end
